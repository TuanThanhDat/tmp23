...
class YoloTest(object):
    ...
    def predict(self, image, image_name):
        ...
        return bboxes, image_isped, time_one_img, isp_param
    ...
    def infer(self, image_path, identity_ratio=0.3):
        ...
        try:
            bboxes_pr, image_isped, time_one_img, isp_param = self.predict(image, image_name)
        except:
            print('==== param failed ====')
        ...
        if filtered_image_batch is not None:
            ...
            cv2.imwrite(f'/home/gb2t/Desktop/AIO_Pending/test_images/{image_name}', filtered_image_batch)
        else:
...
def run_track4():
    ...
    image_path = "/home/gb2t/Desktop/AIO_Pending/test_images/camera19_A_0.png"
    image_name = image_path.split('/')[-1]
